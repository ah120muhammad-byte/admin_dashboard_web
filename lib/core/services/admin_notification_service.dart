...
class AdminNotification {
  ...
  factory AdminNotification.fromMap(
...
class NotificationLecture {
  ...
  const NotificationLecture({
    required this.id,
    required this.title,
  });

  factory NotificationLecture.fromMap(
    Map<String, dynamic> map,
  ) {
...
class NotificationStudent {
  ...
  factory NotificationStudent.fromMap(
    Map<String, dynamic> map,
  ) {
    final fullNameValue =
    ...
    return NotificationStudent(
      id: map['id']?.toString() ?? '',
      fullName: fullNameValue.isEmpty
          ? 'Unnamed student'
          : fullNameValue,
      email: emailValue,
    );
...
class NotificationTargetStudent {
  ...
  factory NotificationTargetStudent.fromMap(
    Map<String, dynamic> map,
  ) {
    final fullNameValue =
        map['full_name']?.toString().trim() ?? '';
...
class AdminNotificationService {
  ...
  Future<List<NotificationLecture>>
      getLectures() async {
  ...
  Future<List<AdminNotification>>
    ...
    final response = await _supabase
        .from('notifications')
        .select(
          'id,title,body,type,lecture_id,created_at',
        )
        .order(
          'created_at',
          ascending: false,
  ...
  Future<List<NotificationStudent>>
      getStudents({
    String search = '',
  }) async {
    var query = _supabase
  ...
  Future<List<NotificationTargetStudent>>
      getTargetStudents({
    ...
    if ((targetType ==
      ...
      throw ArgumentError(
        'Lecture is required for this target.',
      );
    }
    ...
    if (response is! List) {
      throw Exception(
        'Unexpected smart targeting response.',
      );
    }
    ...
    return response
        .map(
          (item) =>
              NotificationTargetStudent.fromMap(
            Map<String, dynamic>.from(
              item,
            ),
          ),
  ...
  Future<AdminNotification>
    ...
    if (normalizedType == 'new_lecture' &&
        (lectureId == null ||
            lectureId.trim().isEmpty)) {
      throw ArgumentError(
        'Lecture is required for a new lecture notification.',
      );
    }
  ...
  // ===========================================================================
  // GET USER IDS WITH DEVICES
  // ===========================================================================

  Future<List<String>>
      getUserIdsWithRegisteredDevices(
    List<String> userIds,
  ) async {
